...
describe("github actions workflow", () => {
  it("keeps desktop and android build jobs wired in", async () => {
    ...
    for (const snippet of [
      ...
      "Install Rust stable with macOS universal targets",
      ...
      "server-addr",
      "xcodebuild archive",
      "Package unsigned iOS IPA",
      "TAURI_IOS_ARCHIVE_PATH",
      "TAURI_IOS_APP_NAME",
      "find \"${ARCHIVE_PATH}/Products/Applications\" -maxdepth 1 -name '*.app' -type d | head -n 1",
      "APP_BUNDLE_NAME",
      "ditto -c -k --sequesterRsrc --keepParent",
      '${APP_BUNDLE_NAME}-unsigned.ipa',
